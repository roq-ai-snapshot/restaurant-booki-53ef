      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: ['special_requests.contains'],
          ...params.filters,
        },
        'reservation',
      ),
  ...
  const columns: ColumnType[] = [
    {
      ...
      cell: ({ row: { original: record } }: any) => (record?.date_time ? format(record?.date_time, 'dd-MM-yyyy') : ''),
    },
    { id: 'number_of_people', header: 'number_of_people', accessorKey: 'number_of_people' },
    { id: 'special_requests', header: 'Special Requests', accessorKey: 'special_requests' },
