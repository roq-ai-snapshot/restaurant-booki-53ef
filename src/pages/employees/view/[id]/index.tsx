...
import { useEmployeeFindFirst, useRoqClient } from 'lib/roq';
...
function EmployeeViewPage() {
  ...
  const queryParams = useMemo<{ include: { user: boolean; restaurant: boolean } }>(
    () =>
  ...
  const { data, error, isLoading } = useEmployeeFindFirst(queryParams, {}, { disabled: !id });
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Hourly Rate" text={data?.hourly_rate} />

                <FormListItem label="Hours Per Week" text={data?.hours_per_week} />
